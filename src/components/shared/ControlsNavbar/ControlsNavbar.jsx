...
const ControlsNavbar = () => {
  return (
    <nav className="fixed bg-slate-700 md:bg-[#00000000] flex flex-row md:flex-col w-full md:w-auto py-5 min-h-auto md:min-h-[100vh] justify-center gap-5 md:bottom-auto md:left-auto left-0  bottom-0">
